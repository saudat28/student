...
if(isset($_POST['submit'])){
    ...
    $email= $_POST['email'];
    $mobile= $_POST['mobile'];
    $sql= "INSERT INTO `students`(`student_id`, `firstname`, `lastname`, `email`, `mobile`, `date`) VALUES (null,'$firstname','$lastname','$email','$mobile',default)";
    $result = mysqli_query($conn,$sql);
        if($result){
            echo '<script>alert("YOUR APPLICATION HAVE SENT SUCCESSFUL")</script>';
    ...
    <section>
        <div class= "content">
            ...
            <div class="grid">
                        ...
                        <div class="columnb">
                        <div class="contain">
                            <h1>PLEASE FILL ALL THE BELOW FIELDS</h1>
                                    ...
                                    <div class="group">
                                            <div class="grid">
                                                ...
                                                <div class="column2">
                                                    ...
                                                    <div class="confirm"> <i class="fa-light fa-asterisk"></i> Please confirm your details before submit</div>
                                                </div>
                                            </div>
