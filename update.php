...
if(isset($_POST['submit'])){
    ...
    $mobile= $_POST['mobile'];
    $date= $_POST['date'];
    $sql= "UPDATE `students` SET  firstname='$firstname', lastname='$lastname', email='$email',mobile='$mobile' where student_id='$id' ";
  ...
  <body>
        ...
        <div class="contain">
            ...
            <div class="group">
                ...
                <label>Mobile:</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="text" name="mobile" value="<?php echo $mobile;?>"  autocomplete="off" ><br>
